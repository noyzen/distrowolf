                                ...
                                localImages.map((img) => (
                                    <FormItem key={img.id} className="relative">
                                        ...
                                        <FormLabel htmlFor={img.id} className={cn(
                                            "flex flex-col items-center justify-center rounded-lg border-2 border-muted bg-popover p-4 h-32 hover:bg-accent/20 hover:text-accent-foreground cursor-pointer transition-all",
                                            ...
                                            <div className="flex flex-col items-center gap-2 text-center">
                                                <i className={cn(getDistroIcon(img.repository), "text-6xl")}></i>
